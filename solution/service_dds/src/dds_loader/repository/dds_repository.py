...
class DdsRepository:
    def __init__(self, db: PgConnect) -> None:
        self._db = db
    """функция для вставки записи в хаб с указанием имени хаба, его атрибутов и значений"""
    ...
    #операция вставки данных 
    """функция для вставки записи в линк между хабами. 
    Она принимает имя двух связанных хабов, значения первого и второго хабов, 
    а также источник загрузки."""
    ...
    #операция вставки данных 
    """функция для вставки записи в сателлит, связанный с определенным хабом.
      Она принимает имя хаба, с которым связан сателлит, 
    имя сателлита, список атрибутов сателлита и соответствующие значения."""
